...
// --- SVG Icons for Dimensions (included for component encapsulation) ---
...
// --- DimensionCard Component (included for component encapsulation) ---
...
interface CreativeBiasSpectrumDisplayProps {
    result: BiasSpectrumAnalysis;
}

export const CreativeBiasSpectrumDisplay: React.FC<CreativeBiasSpectrumDisplayProps> = ({ result }) => {
    return (
        <Card className="animate-fadeInUp" style={{ animationDelay: '300ms' }}>
            <div className="p-6 md:p-8">
                <h2 className="text-2xl font-bold text-slate-800 mb-2">
                    Creative Spectrum for: <span className="text-violet-600">"{result.concept}"</span>
                </h2>
                <p className="text-slate-500 mb-6">
                    This is a creative exploration of the core concept identified in your text to help challenge underlying stereotypes.
                </p>
